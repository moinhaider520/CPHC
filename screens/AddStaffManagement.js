import { ScrollView, StyleSheet, View, Text, TextInput, TouchableOpacity, Switch, Alert } from "react-native";
...
export default function AddStaffManagement(){
  ...
  const [selectedCertificate, setSelectedCertificate] = useState("Upload Certificate");
...
console.log(formattedDate)
  ...
  const createStaff = () => {
    ...
    const apiUrl = BASIC_URL +'createstaffmanagement.php';
    ...
    axios
      ...
      .then((response) => {
        ...
        if (data.status === 'success') {
          ...
          Alert.alert('Error', 'Email for this User Already Exists. Please Use another Email Address.');
        }
      })
      .catch((error) => {
        ...
        <ScrollView style={styles.container}>
            <View style={styles.formcontainer}>
                ...
                <View style={styles.containerinput}>
                    ...
                    <TextInput style={styles.input} placeholder="Sur Name" onChangeText={(text)=>setSurname(text)} />
                </View>
                <View style={styles.containerinput}>
                ...
                <View style={styles.containerinput}>
                    ...
                    <TextInput style={styles.input} placeholder="Telephone / Mobile Number" onChangeText={(text)=>setTelephone(text)}/>
                </View>
                ...
                <View style={styles.containerinput}>
                    ...
                    <TextInput style={styles.input} placeholder="Preffered Shift Pattern" onChangeText={(text)=>setPrefferedShift(text)}/>
                </View>
                ...
                <View style={styles.containerinput}>
                    ...
                    setPosition(itemValue)
                        ...
                        <Picker.Item label="Director of services" value="Director of services" />
