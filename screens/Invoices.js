                ...
                <View style={styles.row}>
                    <View style={styles.width50}>
                        ...
                        <Image source={require('../assets/appointments.png')} style={styles.cardimage}/>
                            <Text style={styles.cardtext}>All Invoices</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.width50}>
                        <TouchableOpacity style={styles.card} onPress={()=>navigation.navigate('ViewInvoicesByServiceUser')}>
                        <Image source={require('../assets/askquestion.png')} style={styles.cardimage}/>
                            <Text style={styles.cardtext}>Service User Invoices</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
